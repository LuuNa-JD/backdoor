...
print(f"Attente de connexion sur {HOST_IP}:{HOST_PORT}".format(HOST_IP=HOST_IP, HOST_PORT=HOST_PORT))
connection_socket, client_address = s.accept()
print(f"Connexion établie avec {client_address}".format(client_address=client_address))
